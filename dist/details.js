...
async function displayCountryDetails(countryCode) {
    try {
        ...
        for (const countryDetail of countryDetails) {
            ...
            const flag = cardFragment.querySelector(".country-card-flag-detail");
            ...
            const nativeName = cardFragment.querySelector(".country-card-native-name");
            const subRegion = cardFragment.querySelector(".country-card-sub-region");
            const tld = cardFragment.querySelector(".country-card-tld");
            const currencies = cardFragment.querySelector(".country-card-currencies");
            const languages = cardFragment.querySelector(".country-card-languages");
